-- =============================================================================
-- Variante admin de get_my_utilities_by_year: el admin puede consultar la
-- distribución mensual de utilidades de cualquier accionista.
-- Misma lógica que get_my_utilities_by_year pero recibe p_user_id y
-- valida is_admin().
-- =============================================================================
...
revoke all on function public.get_user_utilities_by_year(uuid, integer) from public;
grant execute on function public.get_user_utilities_by_year(uuid, integer)
  to authenticated;
